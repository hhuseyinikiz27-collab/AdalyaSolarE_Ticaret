  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-10">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-extrabold text-[#1B3A6B]">Points Leaderboard</h1>
        <p className="text-gray-500 text-sm mt-2">Top loyalty points earners among Adalya Solar customers</p>
      </div>
      ...
      {myRank && (
        <div className="bg-[#1B3A6B] text-white rounded-2xl p-5 mb-6 flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-sm text-blue-200">Your Total Points</p>
      ...
      {!user && (
        <div className="mt-8 text-center bg-orange-50 border border-orange-200 rounded-2xl p-6">
          <p className="text-sm text-gray-600 mb-3">Sign in to see your ranking.</p>
