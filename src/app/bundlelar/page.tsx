    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-extrabold text-[#1B3A6B]">Bundle Packages</h1>
        </div>
        <p className="text-gray-500 mb-10">Save by buying multiple products together.</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-24 text-gray-400">
            ...
            <p className="text-lg font-semibold">No active packages found yet.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {bundles.map(bundle => {
                ...
                <div key={bundle.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col hover:shadow-md transition-shadow">
                  ...
                  <div className="border-t pt-4">
                    ...
                    >
                      ...
                      {isAdded ? 'Added to Cart!' : 'Add Package to Cart'}
                    </button>
                    <p className="text-xs text-gray-400 text-center mt-2">
                      Items are added separately to your cart and shown in your order summary.
                    </p>
                  </div>
                </div>
              );
